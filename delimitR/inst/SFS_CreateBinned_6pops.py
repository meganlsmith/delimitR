            ...
            for r in range(1,nclasses+1):
                for s in range(1,nclasses+1):
                    for t in range(1,nclasses+1):
                        for u in range(1,nclasses+1):
                            for v in range(1,nclasses+1):
                                bin = '%r_%r_%r_%r_%r_%r' % (q,r,s,t,u,v)
...
#    print "Pooling my allele counts..."
    ...
    for i in range(1,classes+1): 
        ...
        lookup_pop5 = 'Thresh_%s_%s' % (Pop_counts.keys()[4], i)
        Thresholds_pop5.append(ThreshCounter[lookup_pop5])
        lookup_pop6 = 'Thresh_%s_%s' % (Pop_counts.keys()[5], i)
        Thresholds_pop6.append(ThreshCounter[lookup_pop6])
    ...
    for i in range(0, len(AFS)):
        ...
        population_5 = key_split[4]
        population_6 = key_split[5]
        ...
        if int(population_5) <= Thresholds_pop5[0]:
            pop_5 = 1
        elif classes > 1 and int(population_5) <= Thresholds_pop5[1]:
            pop_5 = 2
        elif classes > 2 and int(population_5) <= Thresholds_pop5[2]:
            pop_5 = 3
        elif classes > 3 and int(population_5) <= Thresholds_pop5[3]:
            pop_5 = 4
        elif classes > 4 and int(population_5) <= Thresholds_pop5[4]:
            pop_5 = 5
        elif classes > 5 and int(population_5) <= Thresholds_pop5[5]:
            pop_5 = 6
        elif classes > 6 and int(population_5) <= Thresholds_pop5[6]:
            pop_5 = 7
        elif classes > 7 and int(population_5) <= Thresholds_pop5[7]:
            pop_5 = 8
        elif classes > 8 and int(population_5) <= Thresholds_pop5[8]:
            pop_5 = 9
        elif classes > 9 and int(population_5) <= Thresholds_pop5[9]:
            pop_5 = 10

        if int(population_6) <= Thresholds_pop6[0]:
            pop_6 = 1
        elif classes > 1 and int(population_6) <= Thresholds_pop6[1]:
            pop_6 = 2
        elif classes > 2 and int(population_6) <= Thresholds_pop6[2]:
            pop_6 = 3
        elif classes > 3 and int(population_6) <= Thresholds_pop6[3]:
            pop_6 = 4
        elif classes > 4 and int(population_6) <= Thresholds_pop6[4]:
            pop_6 = 5
        elif classes > 5 and int(population_6) <= Thresholds_pop6[5]:
            pop_6 = 6
        elif classes > 6 and int(population_6) <= Thresholds_pop6[6]:
            pop_6 = 7
        elif classes > 7 and int(population_6) <= Thresholds_pop6[7]:
            pop_6 = 8
        elif classes > 8 and int(population_6) <= Thresholds_pop6[8]:
            pop_6 = 9
        elif classes > 9 and int(population_6) <= Thresholds_pop6[9]:
            pop_6 = 10

        keytopop = '%s_%s_%s_%s_%s_%s' % (pop_1,pop_2,pop_3,pop_4,pop_5,pop_6)
